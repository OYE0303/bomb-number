...
class APP {
  ...
  showRandomlySelectLoading() {
    ...
    // add disabled style
    DOM.formCountryRegionSelect.classList.add("form__country__select--disabled")
  ...
  hideForm() {
    ...
    this.formCollection.forEach((form) => form.classList.add("hidden--display"))
  }
  ...
  */
  ...
  addEventListener() {
    ...
    DOM.guessInput.addEventListener("input", this.inputChangeHandler.bind(this))
    ...
    DOM.btnFormLevelBack.addEventListener("click", this.backFormPage.bind(this))
    ...
    DOM.btnFormRangeBack.addEventListener("click", this.backFormPage.bind(this))
